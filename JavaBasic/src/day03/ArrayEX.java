...
public class ArrayEX {
			public static void main(String[] args) {
				...
				// 0, 0.0(실수), false(조건문), null(문자)
				System.out.println( Arrays.toString(arr2));
				
				char[] aww = new char[10];
				System.out.println(Arrays.toString(aww));
				
				// 크기가 7인 문자열 배열을 만들고, 월요일 ~ 일요일 저장
				...
				String[] wke = {"월요일", "화요일", "수요일", "목요일", "금요일", "토요일", "일요일"};
				System.out.println(Arrays.toString(wke));
